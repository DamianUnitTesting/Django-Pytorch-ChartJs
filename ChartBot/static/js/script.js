...
function send(message) {
	...
	$.ajax({
		url: 'http://127.0.0.1:8000/deliberyrequest/',
		type: 'POST',
...
function setBotResponse(val) {
	setTimeout(function () {
		if (val.length < 1) {
			...
			msg = 'Sorry! - I dont have information about that yet!.';
			...
			//for (i = 0; i < val.length; i++) {
				...
				if (val.hasOwnProperty("text")) {
					var BotResponse = '<img class="botAvatar" src="./static/img/botAvatar.png"><p class="botMsg">' + val.text + '</p><div class="clearfix"></div>';
					$(BotResponse).appendTo('.chats').hide().fadeIn(1000);
				}
